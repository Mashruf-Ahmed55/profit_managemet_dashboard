              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("on_hand", Number.parseInt(e.target.value) || 0)}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("available", Number.parseInt(e.target.value) || 0)}
                  />
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="upc" value={formData.upc} onChange={(e) => handleInputChange("upc", e.target.value)} />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="gtin">GTIN</Label>
                  <Input id="gtin" value={formData.gtin} onChange={(e) => handleInputChange("gtin", e.target.value)} />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="wpid">WPID</Label>
                  <Input id="wpid" value={formData.wpid} onChange={(e) => handleInputChange("wpid", e.target.value)} />
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleInputChange("lifecycle_status", value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
